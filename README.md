...
## Installation
    ...
    ./bin/plugin --install xml --url http://xbib.org/repository/org/xbib/elasticsearch/plugin/elasticsearch-xml/1.6.0.1/elasticsearch-xml-1.6.0.1-plugin.zip
