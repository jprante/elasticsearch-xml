...
## Installation
    ...
    ./bin/plugin --install xml --url http://xbib.org/repository/org/xbib/elasticsearch/plugin/elasticsearch-xml/1.6.0.0/elasticsearch-xml-1.6.0.0-plugin.zip
